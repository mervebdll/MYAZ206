...
namespace CollectionsTests
{
    public class CollectionListTest
    {
        ...
        public void Add_Test()
        {
            ...
            // Assert
            Assert.Equal(7, leftList.Count);//Mevcut dizinin eleman sayýsý.
        }
        ...
        [Fact]
        public void InterSection_Test()//Kesiþim 4,5
        {
            // Act
        ...
        [Fact]
        public void Union_Test()//Birleþtirme
        {
            // act
            var unionSet = leftList.Union(rightList);

            // assert
            Assert.Collection(unionSet,  //Collection ifadesi dizinin tüm elemanlarýný dolaþmak ister. Eðer tüm elemanlar verilmez ise hata alýnýr.
